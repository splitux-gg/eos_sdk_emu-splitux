...
#define EOS_USERINFO_COPYUSERINFO_API_003 3
 ...
 */
EOS_STRUCT(EOS_UserInfo_CopyUserInfoOptions003, (
	/** API Version: Set this to EOS_USERINFO_COPYUSERINFO_API_LATEST. */
	int32_t ApiVersion;
	/** The Epic Account ID of the local player requesting the information */
	EOS_EpicAccountId LocalUserId;
...
#define EOS_USERINFO_EXTERNALUSERINFO_API_002 2

/**
 * Contains information about a single external user info.
 */
EOS_STRUCT(EOS_UserInfo_ExternalUserInfo002, (
