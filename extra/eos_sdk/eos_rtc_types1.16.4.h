...
#define EOS_RTC_JOINROOM_API_001 1
...
#define EOS_RTC_JOINROOMFLAGS_ENABLE_ECHO 0x01
  ...
  */
EOS_STRUCT(EOS_RTC_JoinRoomOptions001, (
...
#define EOS_RTC_LEAVEROOM_API_001 1

/**
 * This struct is used to call EOS_RTC_LeaveRoom.
 */
EOS_STRUCT(EOS_RTC_LeaveRoomOptions001, (
...
#define EOS_RTC_BLOCKPARTICIPANT_API_001 1

/**
 * This struct is passed in with a call to EOS_RTC_BlockParticipant.
 */
EOS_STRUCT(EOS_RTC_BlockParticipantOptions001, (
...
#define EOS_RTC_ADDNOTIFYDISCONNECTED_API_001 1

/**
 * This struct is used to call EOS_RTC_AddNotifyDisconnected.
 */
EOS_STRUCT(EOS_RTC_AddNotifyDisconnectedOptions001, (
...
#define EOS_RTC_PARTICIPANTMETADATA_API_001 1

/**
 * This struct is used to get information about a specific participant metadata item.
 */
EOS_STRUCT(EOS_RTC_ParticipantMetadata001, (
...
#define EOS_RTC_ADDNOTIFYPARTICIPANTSTATUSCHANGED_API_001 1

/**
 * This struct is used to call EOS_RTC_AddNotifyParticipantStatusChanged.
 */
EOS_STRUCT(EOS_RTC_AddNotifyParticipantStatusChangedOptions001, (
...
EOS_STRUCT(EOS_RTC_ParticipantStatusChangedCallbackInfo, (
	enum { k_iCallback = k_iRTCCallbackBase + 4 };
...
#define EOS_RTC_SETSETTING_API_001 1
 ...
 */
EOS_STRUCT(EOS_RTC_SetSettingOptions001, (
...
#define EOS_RTC_SETROOMSETTING_API_001 1
 ...
 * - DisableDtx: Allows to disable the use of DTX.  Default "False".
 */
EOS_STRUCT(EOS_RTC_SetRoomSettingOptions001, (
...
#define EOS_RTC_ADDNOTIFYROOMSTATISTICSUPDATED_API_001 1

/**
 * This struct is used to call EOS_RTC_AddNotifyRoomStatisticsUpdated.
 */
EOS_STRUCT(EOS_RTC_AddNotifyRoomStatisticsUpdatedOptions001, (
...
EOS_STRUCT(EOS_RTC_RoomStatisticsUpdatedInfo, (
	enum { k_iCallback = k_iRTCCallbackBase + 5 };
